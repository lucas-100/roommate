...
describe ExpensesController do
  before(:each) do
    ...
    expenses.stub_chain(:includes, :order, :all).and_return(expenses)
  ...
  describe "GET show" do
    it "assigns @expense" do
      ...
      Expense.stub_chain(:where, :find).and_return(expense)
      get :show, {:id => 1}
  ...
  describe "GET edit" do
    ...
    it "assigns @people" do
      people = [mock_model(Person).as_null_object]
      Person.stub_chain(:where, :all).and_return(people)
  ...
  describe "POST create" do
    ...
    context "on successful save" do
      before { expense.stub!(:save).and_return(true) }
  ...
  describe "POST update" do
    ...
    context "on successful update" do
      before { expense.stub!(:update_attributes).and_return(true) }
